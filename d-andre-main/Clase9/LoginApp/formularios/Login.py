...
from util.generic import leer_imagen as utl
...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen(r"LoginApp\imagenes", (300, 100))
        self.user = utl.leer_imagen(r"LoginApp\imagenes", (64, 64))
    ...
    def validar(self):
        with open(r"C:\Users\Monitor.Saber\Music\d-andre-main\Clase9", "r", encoding='utf-8') as file:
