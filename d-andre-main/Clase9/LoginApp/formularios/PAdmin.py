...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.usrimg = utl.leer_imagen(r"C:\Users\Monitor.Saber\Music\d-andre-main\Clase9\LoginApp\imagenes", (128, 128))
        self.imgfacebook = utl.leer_imagen(r"C:\Users\Monitor.Saber\Music\d-andre-main\Clase9\LoginApp\imagenes", (32, 32))
        self.imglinkedin = utl.leer_imagen(r"C:C:\Users\Monitor.Saber\Music\d-andre-main\Clase9\LoginApp\imagenes", (32, 32))
        self.imgwebsite = utl.leer_imagen(r"C:\Users\Monitor.Saber\Music\d-andre-main\Clase9\LoginApp\imagenes", (32, 32))
        self.imglogout = utl.leer_imagen(r"C:\Users\Monitor.Saber\Music\d-andre-main\Clase9\LoginApp\imagenes", (32, 32))
    ...
    def listar_usuarios(self):
        ...
        with open(r"LoginApp/db_users", "r", encoding='utf-8') as self.file:
    ...
    def save_user(self):
        ...
        if self.ccedula.get() =="" or self.cnombre.get() == "" or self.cusuario.get() == "" or self.ccorreo.get() == "" or self.cclave.get() == "" or self.tipo_user == "":
            ...
            return 
                ...
                with open(r"LoginApp\db_users.json", "r", encoding='utf-8') as self.file:
                        self.db_users = json.load(self.file)
                        ...
                        if self.tipo_action == "Actualizar":
                            ...
                            for usuarios in self.db_users["users"]:
                                if usuarios["id"] == self.tablausuarios.item(self.tablausuarios.selection())["text"]:
                                    ...
                                    with open(r'C:\LoginApp\db_users.json', 'w') as jf: 
    ...
    def delete_user(self):
        with open(r"C:\LoginApp\db_users.json", "r", encoding='utf-8') as self.file:
                self.db_users = json.load(self.file)
                for usuarios in self.db_users["users"]:
                    if usuarios["id"] == self.tablausuarios.item(self.tablausuarios.selection())["text"]:
                        self.db_users["users"].remove(usuarios)
                        with open(r'C:\db_users.json', 'w') as jf:
                            json.dump(self.db_users, jf, indent=4, ensure_ascii=True)
    ...
    def update_user(self):
        with open(r"C:\db_users.json", "r", encoding='utf-8') as self.file:
                self.db_users = json.load(self.file)
                for usuarios in self.db_users["users"]:
                    if usuarios["id"] == self.tablausuarios.item(self.tablausuarios.selection())["text"]:
